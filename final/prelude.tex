...
\hline 
Final Report & PDF file & PDF uploaded to Minerva (DD/MM/YY) \\ 
\hline 
Link to online code repository & \href{https://gitlab.com/rakagunarto/final-project}{URL} & Sent to supervisor and assessor (DD/MM/YY) \\ 
\hline 
Link to demo video & URL & Sent to client and supervisor (DD/MM/YY) \\ 
\hline 
\end{tabular} 
\end{table}
